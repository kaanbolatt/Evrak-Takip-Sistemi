                ...
                <form action="nedmin/netting/islem.php" method="POST" role="form">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                            ...
                            <input type="text" id="last-name" required="" placeholder="Güvenlik Kodunu Giriniz" name="captcha_codee" class="form-control">
                  </div>
                 ...
                 <div class="form-group">
                   <button type="submit" name="kullanicigiris" class="btn btn-default btn-red btn-sm">Giriş Yap</button>
  										...
  										<div class="col-md-6">
  											...
  											<p>
  												Yeni Kullanıcı mısın? Sisteme giriş için kayıt olmalısın !
  											</p>
  											<a href="register.php"><button class="btn btn-default btn-yellow">Kayıt Ol</button>
  										</div>
  									</div>
  								</div>
  								<div>
...
<ul class="small-menu">
  ...
  <li><a href="deneme-ekle.php" class="fa fa-file"> Evrak Gönder</a></li>
  <li><a href="evrak.php" class="fa fa-file"> Evrak İndirme</a></li>
  <li><a href="gönderilenler.php" class="fa fa-file"> Gönderilen Evraklar</a></li>
